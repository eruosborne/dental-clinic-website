...
export const BLOG_POSTS: BlogPost[] = [
  {
    slug: "why-new-zealanders-fly-for-dental-tourism",
    title: "Why New Zealanders Are Flying for Dental Tourism",
    excerpt:
    ...
    heroEmoji: "✈️",
    paragraphs: [
      "Dental tourism to Southeast Asia has become a well-worn path for thousands of New Zealanders every year — and the reasons are both simple and compelling. The same dental implants that cost NZD 6,500–8,000 in Auckland cost around NZD 1,100–1,800 at an accredited clinic in Southeast Asia. Multiply that across a full treatment plan, and the savings dwarf the cost of return airfares.",
      "Southeast Asia has become the preferred destination for dental tourism for a specific reason: the concentration of internationally trained, English-first clinics. Unlike some destinations where you're navigating language barriers and uncertain credentials, top dental practices actively court international patients — English-speaking coordinators, written records sent to your home dentist, and pre-visit AI consultations that answer your questions before you step on a plane.",
      "The typical Smile Dental Clinic patient from New Zealand flies in for 5–7 days. That's enough time for a single dental implant start-to-finish, a full smile makeover with veneers, or a root canal and crown combination that would have been deferred for months back home due to cost. In that same week, they can explore local attractions, relax, and return home with a completed treatment plan rather than a waiting list appointment.",
      "The math is hard to argue with. A return flight from Auckland to Southeast Asia averages NZD 700–1,100. A comfortable hotel near the clinic runs NZD 80–150 per night. Five nights of accommodation plus flights totals roughly NZD 1,500–1,850. For a patient saving NZD 9,000 on two implants, that's a net saving of over NZD 7,000 — and a holiday in Southeast Asia.",
      "The question most NZ patients ask us is: 'But is the quality really comparable?' Our answer is always the same: come and see. We use Straumann and Nobel Biocare implant systems — the same brands your Auckland dentist uses. Our CBCT scanner and digital smile planning software are identical to what you'd find in a premium New Zealand practice. The difference isn't the equipment or the training — it's the operating cost of running a business in Southeast Asia versus New Zealand. That gap is what you keep.",
      "If you've been putting off dental work because of the cost, dental tourism isn't a compromise. It's the option that makes the treatment actually possible.",
    ],
  },
  {
    ...
    paragraphs: [
      ...
      "The implant then needs time to osseointegrate — fuse with your jawbone. For most patients visiting our clinic, this is where the timeline splits. If you're getting an immediate-load implant (a temporary crown placed the same day), you leave with a functional tooth. The permanent crown is fitted either during a follow-up visit or, increasingly, done remotely: our clinic sends the specifications to a lab in your home city, and your local dentist fits the final crown.",
      "Bone grafting is sometimes required when the jawbone has deteriorated after a long-term tooth absence. This adds cost (roughly NZD 350–700 at Smile Dental Clinic vs. NZD 1,500–3,500 in New Zealand) and extends the overall timeline, as the graft needs to heal before implant placement. Our pre-visit CBCT analysis — which we can perform on imaging you send us ahead of your trip — tells you before you book flights whether grafting will be needed.",
  ...
  },
  {
    ...
    excerpt:
      "A practical, honest guide to post-treatment recovery — written for patients who are also trying to enjoy their trip.",
    category: "Recovery",
    ...
    paragraphs: [
      ...
      "The practical recovery tip: don't plan your most ambitious day trip for the day immediately after surgery. Give yourself one calm day — a relaxing walk, gentle sightseeing, or simply a relaxed afternoon by the pool. By day two or three, most patients are fully back to exploring.",
  ...
  {
    slug: "5-days-dental-holiday",
    title: "5 Days: Combining Dental Work With a Holiday",
    excerpt:
    ...
    heroEmoji: "🌏",
    paragraphs: [
      "The question we hear from hesitant patients is usually framed like a trade-off: 'Am I going to spend my whole trip at the clinic?' The answer is no. A well-planned dental visit takes up roughly two to four clinic hours per day, maximum — leaving mornings, evenings, and full days free. Here's how a realistic 5-day visit actually looks for most of our patients.",
      "Day 1 (Arrival): Most flights arrive late morning or afternoon. Check into your hotel and relax. Your first appointment is a consultation and 3D scan: 90 minutes at the clinic, relaxed and diagnostic. Afternoon: recover from travel, explore the area, enjoy local cuisine. Evening: explore local attractions.",
      "Day 2 (Primary treatment): This is your main procedure day. For implant patients, surgery is typically 8–10 AM — done by late morning. For veneer patients, tooth preparation and temporary placement takes 2–3 hours. By lunchtime you're done. Afternoon (for implant patients): rest, soft food, gentle walk. For veneer or cosmetic patients: completely unrestricted. Explore local attractions.",
      "Day 3 (Free day): Most patients take this day entirely off. Explore local areas and attractions at your own pace. For implant patients who feel well, this is completely appropriate.",
      "Day 4 (Follow-up or second treatment): Depending on your treatment, this is either a progress check (30 minutes) or a second session — crown fitting, final adjustments, or the start of a second procedure. For most cosmetic patients, final impressions and adjustments happen today. By noon you're free.",
      "Day 5 (Final check and departure): A brief final check and post-treatment briefing — usually 45 minutes. You receive your treatment records, warranty documentation, and your home country dentist's summary. Then: airport. You go home with a completed treatment plan, a holiday's worth of memories, and thousands of dollars still in your account.",
    ],
  },
  {
    ...
    heroEmoji: "💰",
    paragraphs: [
      "One of our patients — we'll call her Karen, from Auckland — arrived with a treatment plan from her New Zealand dentist. The plan called for six porcelain crowns, two implants, and a full arch whitening. The quote: NZD 34,500. Karen had been sitting on this quote for two years because the number simply wasn't achievable. She found us through a friend who'd come to Da Nang for veneers. Here's exactly what her treatment cost at Smile Dental Clinic.",
      "Six porcelain crowns: NZD 1,800 each in Auckland, NZD 300 each at Smile Dental Clinic. Total Auckland: NZD 10,800. Total Smile Dental Clinic: NZD 1,800. Two dental implants (Straumann, complete with crowns): NZD 7,000 each in Auckland, NZD 1,400 each at Smile Dental Clinic. Total Auckland: NZD 14,000. Total Smile Dental Clinic: NZD 2,800. Full arch professional whitening: NZD 800 in Auckland, NZD 120 at Smile Dental Clinic. Combined treatment total: Auckland NZD 25,600, Smile Dental Clinic NZD 4,720.",
